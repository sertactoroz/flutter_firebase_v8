        ...
        <div class="page-body">
          <div class="container-xl">
            <div class="row row-deck row-cards">
              ...
              <div class="card">
                  <div class="card-body">
                      <div><img src="images/solar.png"></div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-lg-12">
                <div class="row row-cards">
                  <div class="col-12">
                    <div class="card">
                      <div class="card-body">
                        <p class="mb-3">Using Capacity <strong>6854.45 MW </strong>of 8 GW</p>
                    ...
                    <table class="table table-vcenter">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="td-truncate">
                            <div class="text-truncate">
                            Control System Upgrade (#29840)                            </div>
                          </td>
                        ...
                        <tr>
                          ...
                          <td class="td-truncate">
                            <div class="text-truncate">
                            Hub Height Adjustment (#29853)                            </div>
                          </td>
                        ...
                        <tr>
                          ...
                          <td class="td-truncate">
                            <div class="text-truncate">
                            Temperature Data Analysis (#29864)                            </div>
                          </td>
                          <td class="text-nowrap text-muted">26 Nov 2019</td>
                        </tr>
                        <tr>
                          ...
                          <td class="td-truncate">
                            <div class="text-truncate">
                            Grid Integration Test (#29872)                            </div>
                          </td>
                    ...
                    <table class="table card-table table-vcenter text-nowrap datatable">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><a href="UV-T3-2315.php" class="text-reset" tabindex="-1"> UV-T3-2315</a></td>
                          <td>
                          ...
                          <td>
                            <span class="badge bg-success me-1"></span>  High 
                          </td>
                          <td>$887</td>
                          <td class="text-end">
                            <span class="dropdown">
                        ...
                        <tr>
                          ...
                          <td><a href="UV-T3-2315.php" class="text-reset" tabindex="-1">UV-TG-2313</a></td>
                          <td>
                          ...
                          <td>
                            <span class="badge bg-warning me-1"></span> Above-Average
                          </td>
                          <td>$1200</td>
                          <td class="text-end">
                            <span class="dropdown">
                        ...
                        <tr>
                          ...
                          <td><a href="UV-T3-2315.php" class="text-reset" tabindex="-1">UV-T7-2113</a></td>
                          <td>
                        ...
                        <tr>
                          ...
                          <td><a href="UV-T3-2315.php" class="text-reset" tabindex="-1">UV-TF-2343</a></td>
                          <td>
                          ...
                          <td>
                            <span class="badge bg-secondary me-1"></span> Low 
                          </td>
                          <td>$1500</td>
                          <td class="text-end">
                            <span class="dropdown">
                        ...
                        <tr>
                          ...
                          <td><a href="UV-T3-2315.php" class="text-reset" tabindex="-1">UV-T4-2213</a></td>
                          <td>
                          ...
                          <td>
                            <span class="badge bg-danger me-1"></span> Very Low 
                          </td>
                          <td>$648</td>
                          <td class="text-end">
                            <span class="dropdown">
                        ...
                        <tr>
                          ...
                          <td><a href="UV-T3-2315.php" class="text-reset" tabindex="-1">UV-T1-2223</a></td>
                          <td>
                            <span class="flag flag-country-br"></span>
                            Tabdaq
                          </td>
                        ...
                        <tr>
                          ...
                          <td><a href="UV-T3-2315.php" class="text-reset" tabindex="-1">UV-TT-2213</a></td>
                          <td>
                            <span class="flag flag-country-us"></span>
                            Apple
                          </td>
                        ...
                        <tr>
                          ...
                          <td><a href="UV-T3-2315.php" class="text-reset" tabindex="-1">UV-T0-2244</a></td>
                          <td>
                            <span class="flag flag-country-pl"></span>
                            Tookapic
                          </td>
