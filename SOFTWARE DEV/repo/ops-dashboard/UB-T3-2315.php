           ...
           <!-- Medium containers -->
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="subheader">State of Charge (SoC)</div>
              ...
              <div class="col-sm-6 col-lg-3">
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="subheader">Open Circuit Voltage (OCV)</div>
                      <div class="ms-auto lh-1">
                        <div class="dropdown">
                          <a class="dropdown-toggle text-muted" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Last 7 days</a>
                          <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <div class="d-flex align-items-baseline">
                      <div class="h1 mb-0 me-2">3.8 V</div>
                      <div class="me-auto">
                        <span class="text-green d-inline-flex align-items-center lh-1">
              ...
              <div class="col-sm-6 col-lg-3">
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="subheader">Specific Energy</div>
                      <div class="ms-auto lh-1">
                        <div class="dropdown">
                          <a class="dropdown-toggle text-muted" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Last 7 days</a>
                          <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <div class="d-flex align-items-baseline">
                      <div class="h1 mb-3 me-2">150 Wh/kg<br>/m²/day</div>
                      <div class="me-auto">
              ...
              <div class="col-sm-6 col-lg-3">
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="subheader">Discharge Rate</div>
                      <div class="ms-auto lh-1">
                        <div class="dropdown">
                          <a class="dropdown-toggle text-muted" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Last 7 days</a>
                          <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <div class="d-flex align-items-baseline">
                      <div class="h1 mb-3 me-2">15 A</div>
                      <div class="me-auto">
                        <span class="text-green d-inline-flex align-items-center lh-1">
                    ...
                    <table class="table table-vcenter">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="td-truncate">
                            <div class="text-truncate">
                            Inverter Firmware Update(#29604)
                            </div>
                          </td>
                        ...
                        <tr>
                          ...
                          <td class="td-truncate">
                            <div class="text-truncate">
                            Battery Capacity Testing (#29734)
                            </div>
                          </td>
                        ...
                        <tr>
                          ...
                          <td class="td-truncate">
                            <div class="text-truncate">
                            Solar Energy Yield Analysis (#29736)
                            </div>
                          </td>
                          <td class="text-nowrap text-muted">26 Nov 2019</td>
                        </tr>
                        <tr>
                          ...
                          <td class="td-truncate">
                            <div class="text-truncate">
                            PV Cell Health Assessment (#29730)
