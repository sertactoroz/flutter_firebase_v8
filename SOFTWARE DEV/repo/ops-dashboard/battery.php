        ...
        <div class="page-body">
          <div class="container-xl">
            <div class="row row-deck row-cards">
              ...
              <div class="card">
                  <div class="card-body">
                      <div><img src="images/battery.png"></div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-lg-12">
                <div class="row row-cards">
                  <div class="col-12">
                    <div class="card">
                      <div class="card-body">
                        <p class="mb-3">Using Capacity <strong>7154.45 MW </strong>of 8 GW</p>
                    ...
                    <table class="table table-vcenter">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="td-truncate">
                            <div class="text-truncate">
                            BMS Software Upgrade (#29840)                            </div>
                          </td>
                        ...
                        <tr>
                          ...
                          <td class="td-truncate">
                            <div class="text-truncate">
                            Charge Rate Optimization (#29853)                            </div>
                          </td>
                          <td class="text-nowrap text-muted">26 Nov 2019</td>
                        </tr>
                        <tr>
                          <td class="w-1">
                          <span class="avatar avatar-sm">MST</span>                          </td>
                          <td class="td-truncate">
                            <div class="text-truncate">
                            Cell Health Assessment (#29853)                            </div>
                          </td>
                          <td class="text-nowrap text-muted">26 Nov 2019</td>
                        </tr>
                        <tr>
                    ...
                    <table class="table card-table table-vcenter text-nowrap datatable">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><a href="UB-T3-2315.php" class="text-reset" tabindex="-1"> UB-T3-2315</a></td>
                          <td>
                        ...
                        <tr>
                          ...
                          <td><a href="UB-T3-2315.php" class="text-reset" tabindex="-1">UB-TG-2313</a></td>
                          <td>
                        ...
                        <tr>
                          ...
                          <td><a href="UB-T3-2315.php" class="text-reset" tabindex="-1">UB-T7-2113</a></td>
                          <td>
                        ...
                        <tr>
                          ...
                          <td><a href="UB-T3-2315.php" class="text-reset" tabindex="-1">UB-TF-2343</a></td>
                          <td>
                        ...
                        <tr>
                          ...
                          <td><a href="UB-T3-2315.php" class="text-reset" tabindex="-1">UB-T4-2213</a></td>
                          <td>
                        ...
                        <tr>
                          ...
                          <td><a href="UB-T3-2315.php" class="text-reset" tabindex="-1">UB-T1-2223</a></td>
                          <td>
                            <span class="flag flag-country-br"></span>
                            Tabdaq
                          </td>
                        ...
                        <tr>
                          ...
                          <td><a href="UB-T3-2315.php" class="text-reset" tabindex="-1">UB-TT-2213</a></td>
                          <td>
                            <span class="flag flag-country-us"></span>
                            Apple
                          </td>
                        ...
                        <tr>
                          ...
                          <td><a href="UB-T3-2315.php" class="text-reset" tabindex="-1">UB-T0-2244</a></td>
                          <td>
                            <span class="flag flag-country-pl"></span>
                            Tookapic
                          </td>
